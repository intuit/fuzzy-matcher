...
public class ElementTest {
    ...
    public void itShouldSetScoringFunction() {
        Document d1 = new Document.Builder("1")
                .addElement(new Element.Builder().setType(NAME).setValue("James Franco Parker").setScoringFunction(getFullScore()).createElement())
                .createDocument();
        Document d2 = new Document.Builder("2")
                .addElement(new Element.Builder().setType(NAME).setValue("James Parker").setScoringFunction(getFullScore()).createElement())
                .createDocument();
